...
class MovistarFileGenerator:
 ...
 """
 logger.info("[INFO] Generando Contact Log...")
 
 if df.empty:
 logger.warning("[WARNING] No hay datos para Contact Log")
 return
 ...
 logger.info(f"[OK] Contact Log generado: {len(df_contact)} registros")
 ...
 - Contact_Log
 """
 logger.info("[INFO] Generando FORMATO MOVISTAR...")
 ...
 logger.info(f"[OK] FORMATO MOVISTAR generado: {len(df_formato)} registros")
 ...
 NOTA: El DataFrame ya viene filtrado desde generate_movistar_files
 """
 logger.info(f"[INFO] Generando SVAS {tipo}...")
 
 # El DataFrame ya viene filtrado, no necesitamos filtrar de nuevo
 if df.empty:
 logger.warning(f"[WARNING] No hay datos para SVAS {tipo}")
 return
 ...
 logger.info(f"[OK] SVAS {tipo} generado: {len(df_svas)} registros")
 ...
 """
 logger.info(f"[INFO] Generando FORMATO MOVISTAR_{tipo}...")
 ...
 logger.info(f"[OK] FORMATO MOVISTAR_{tipo} generado: {len(df_formato)} registros")
 ...
 - Contact_Log
 """
 logger.info("[INFO] Generando OCTUBRE_Exitosas_Movistar...")
 ...
 logger.info(f" [EMOJI] Hoja '{sheet_name}': {len(df_sheet)} registros")
 
 logger.info(f"[OK] OCTUBRE_Exitosas_Movistar generado")
...
def generate_movistar_files(
 ...
 logger.info("=" * 80)
 logger.info("[FASE] GENERANDO ARCHIVOS PARA MOVISTAR (FORMATOS REALES)")
 logger.info("=" * 80)
 ...
 for tipo, tipo_linea, file_key in [
 ('DIG', 'DIGITAL', 'movistar_svas_dig'),
 ('FIJA', 'FIJA', 'movistar_svas_fija'),
 ('MOV', 'MOVIL', 'movistar_svas_mov')
 ]:
 if tipo == 'DIG':
 ...
 logger.info("[OK] Archivos para Movistar generados")
...
def generate_internal_files(
 ...
 logger.info("=" * 80)
 logger.info("[FASE] GENERANDO ARCHIVOS INTERNOS")
 logger.info("=" * 80)
 ...
 logger.info("[OK] Archivos internos generados")
