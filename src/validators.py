...
class PhoneNumberValidator:
 ...
 national = ''.join(filter(str.isdigit, national))
 ...
 """
 logger.info(f"[INFO] Validando {len(series):,} números telefónicos...")
...
class DataQualityValidator:
 ...
 logger.warning(
 f"[INFO] Columnas con alta tasa de nulos en '{df_name}': "
 ...
 logger.warning(
 f"[INFO] {duplicate_count:,} filas completamente duplicadas en '{df_name}'"
 )
 ...
 'estadisticas': stats,
 'estado': f'[WARNING] REVISAR' if null_rate > 0.3 else f'[WARNING] OK'
 })
