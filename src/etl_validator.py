...
class ETLValidator:
    ...
    def validate_business_rules(
        ...
        for rule in rules:
            ...
            try:
                ...
                if result:
                    checks_passed.append(f"✓ {rule_name}")
                else:
                    checks_failed.append(f"✗ {rule_name}")
                ...
                checks_failed.append(f"✗ {rule_name}: {str(e)}")
    ...
    def export_report(self, output_path: Path) -> None:
        ...
        self.logger.info(f"✅ Validation report exported: {output_path}")
